...
function ButtonDelete(element, type, typeValue, value, valueValue) {
    ButtonDelete.accountantID = -1;
...
addDo.add();
console.log(ButtonDelete.accountantID)
